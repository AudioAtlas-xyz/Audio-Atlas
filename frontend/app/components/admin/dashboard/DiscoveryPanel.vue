...
<template>
  <div class="space-y-6">
    <div class="border-b border-border pb-4">
      ...
      <p class="mt-1 text-xs text-meta">Search patterns from the public search bar</p>
    </div>
      ...
      <div class="rounded-md border border-[#5a1a5c] bg-[#0d080e] p-5 space-y-4">
        <div class="flex items-start justify-between gap-2">
          <div>
            ...
            <p class="mt-1 text-[11px] text-meta">Demand worklist — these feed the content roadmap</p>
          </div>
        ...
        <p v-else class="text-xs text-label">No zero-result searches in this window</p>
      </div>

      <!-- Top searches -->
      <div class="rounded-md border border-border bg-surface p-5 space-y-4">
        <p class="font-mono text-[10px] uppercase tracking-[0.18em] text-meta">Top searches</p>
        ...
        <p v-else class="text-xs text-label">No search data in this window</p>
      </div>
    </div>
  </div>
</template>
